...
{
	//add_menu_page('Follow US','Follow Us',7,'fnFollowusPlugin','fnFollowus');
...
//add_action('wp_head','fnDisplayFollowusLinks');
//if(function_exists('fnDisplayFollowusLinks')){ fnDisplayFollowusLinks();} ?>